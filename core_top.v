...
module core_top (
    ...
    output wire [31:0] debug_exec_result,
    output wire [31:0] debug_rs1_data,
    output wire [31:0] debug_rs2_data,
    ...
    wire        branch_taken_dec;
    wire [31:0] branch_target_dec;
    wire        jump_out;
    wire        valid_instr;
    ...
    assign debug_exec_result   = exec_result_dec;
    assign debug_rs1_data      = rs1_data_dec;
    assign debug_rs2_data      = rs2_data_dec;
    assign debug_mem_addr      = exec_result_dec;
    assign debug_mem_wdata     = rs2_data_ex;
    assign debug_mem_write     = mem_write_ex;
    assign debug_branch_taken  = branch_taken_ex;
    assign debug_jump          = jump_out;
    ...
    decode_execute u_decode_execute (
        ...
        .branch_taken_out  (branch_taken_dec),
        .branch_target_out (branch_target_dec),
        .jump_out          (jump_out),
